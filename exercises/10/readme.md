...
> If you are not sure what your SAP Cloud Platform credentials are, make sure you have a SAP Cloud Platform Cloud Foundry Trial as described in the [Prerequisites - SAP Cloud Platform](https://github.com/SAP-samples/cloud-cap-nodejs-codejam/blob/master/prerequisites.md#cloud-platform).
